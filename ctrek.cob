      ...
      *>***********************************************
       ...
       0100-housekeeping.
           ...
           display z-or " Betazoid ships are patrolling ready to assist"
       ...
       0500-prt-inst.
           ...
           display "       com  (to request info from the library PC)"
           display "      ".
           display "COURSE PLOT: ".
           display "      ".
           display "    1 ".
       ...
       0550-add-inst.
           display"There are " vae1 " star bases located in the galaxy".
           display "which is made up of 81 quadrants, 1,1 thru 9,9. ".
           display "You may dock at a star base to refuel and repair ".
           display "when there is a base in your quadrant."
           display "You are authorized to destroy Romulon vessels".
           display "if they interfere with your mission. "
           display "      ".
           display "Hit RETURN ".
           accept return-x.
       0550-exit.  exit.
      ...
      *>*********************************************
       ...
       1200-initialize-galaxy.
           ...
           perform 1235-move-betazoids thru 1235-exit
               varying star-ctr from 1 by 1 until star-ctr > z-or.
      ...
      *>*******************************************
       ...
       2000-process.
           ...
           if navigate or nav-c
               if entry1 not numeric or entry1 < 1
                or entry1 > 8 or entry2 not numeric
      ...
      *>**************************************
       ...
       3000-com-fun.
           ...
           if comp-com not numeric or comp-com < 1 or comp-com > 6
               ...
               accept lst-reply
               if yes-lst
                   display "Functions available from the library PC: "
                   display "     1  To request ship status "
                   display "     2  To request short range scan "
      ...
      *>******************************************
       ...
       4000-display-g.
           ...
           inspect mini-table tallying romulons for all "R".
           inspect mini-table tallying base-cnt for all "B".
           inspect mini-table tallying betazoids for all "Z".
           display "      ".
           if just-starting
               ...
               if klgns > 0
                   ...
                   display con-green
               if betazoids > 0 
                   display "*BETAZOID SHIPS IN THE QUADRANT* "
               else 
                   next sentence
           else 
               if klgns > 0
       ...
       7000-nav-ck.
           if srctr < 1 or srctr > 126 or skctr < 1 or skctr > 126
               ...
               if macol (mrctr , mkctr) = "K"
                 or macol (mrctr , mkctr) = "R"
                 or macol (mrctr , mkctr) = "B"
      ...
      *>*******************************************
       ...
       7200-pha.
           ...
           if fuel-count < 9999
               ...
               display "Maximum of " fuel-co " units available".
       ...
       7250-romulon-ck.
           if romulons > 2 and no-way
               ...
               if no-way or var4 < 447
                   ...
                   perform 8400-generate thru 8400-exit
                   if no-way
                       display "*ENTERPRISE DESTROYED BY TORPEDO* "
                       move 1 to indicate-x
                       perform 8200-ck-done thru 8200-exit
                   else
       ...
       7300-tor.
           if klgns < 1 and romulons < 1
               display "There are 0 enemies in this quadrant, " name-x
               go to 7300-exit.
           perform 8400-generate thru 8400-exit.
           ...
           if torps > 0
               if klgns > 0
                   ...
                   display "There are 0 Klingons in this quadrant"
           else
       ...
       7600-doc.
           ...
           if base-cnt > 0
               ...
               if dist-b < 7
                   ...
                   display "You must move to within 6 parsecs to dock "
           else
       ...
       8000-bomb.
           if macol (mrctr , mkctr) = "K"
               ...
               if macol (mrctr , mkctr) = "R"
                   display "*ENTERPRISE DESTROYED IN COLLISION"
               else
                   display "*ENTERPRISE DESTROYED IN COLLISION".
           move 1 to indicate-x.
           perform 8200-ck-done thru 8200-exit.
      ...
      *>***************************************************
       ...
       8160-test-agn.
           if var2 < 525 and romulons > 0
               add 254 to var2
               compute var2 = (romulons * var2 / 4.7)
                + (var2 * damage-cnt / 365).
       8160-exit.  exit.
      ...
      *>************************************************
       ...
       8300-ck-fuel-damage.
           ...
           if damage-cnt > 6000
               ...
               perform 8200-ck-done thru 8200-exit.
           if damage-cnt > 4500
               display "Damage Control reports heavy damage".
